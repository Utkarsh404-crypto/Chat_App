...
const SignUp = () => {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const { data } = await axios.post(
                "/api/user", { name, email, password, profile_pic },
                config
            );
            toast({
    ...
    return ( <
        ...
        Button h = "1.75rem"
        size = "sm"
        onClick = { handleClickPass } > { " " } { showPass ? "Hide" : "Show" } { " " } <
        /Button>{" "} < /
        InputRightElement > { " " } <
        /InputGroup>{" "} < /
        FormControl > { " " } <
        ...
        Button h = "1.75rem"
        size = "sm"
        onClick = { handleClickConfPass } > { " " } { showConfPass ? "Hide" : "Show" } { " " } <
        /Button>{" "} < /
        InputRightElement > { " " } <
        /InputGroup>{" "} < /
        FormControl > { " " } <
        ...
        accept = "image/*"
        onChange = {
            (e) => handleChangePic(e.target.files[0])
        }
        />{" "} < /
        FormControl > { " " } <
